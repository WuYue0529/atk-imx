...
# setenv bootargs 'console=tty1 console=ttymxc0,115200 root=/dev/nfs nfsroot=192.168.31.131:/home/zk/imx/atk-imx6ull/rootfs rw ip=192.168.31.251:192.168.31.131:192.168.1.1:255.255.255.0::eth0:off'
